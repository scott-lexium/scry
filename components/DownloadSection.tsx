...
const platforms = [
  {
    ...
    key: 'mac',
    primaryHref: DL('scry-mac-arm64.dmg'),
    downloads: [
      { label: 'Apple Silicon (arm64)', size: '~85 MB', href: DL('scry-mac-arm64.dmg') },
      { label: 'Intel (x64)',           size: '~88 MB', href: DL('scry-mac-x64.dmg') },
    ],
  ...
  },
  {
    ...
    key: 'win',
    primaryHref: DL('scry-win-x64.exe'),
    downloads: [
      { label: 'Installer (.exe)',      size: '~78 MB', href: DL('scry-win-x64.exe') },
      { label: 'Portable (no install)', size: '~78 MB', href: DL('scry-win-x64-portable.exe') },
    ],
  ...
  },
  {
    ...
    key: 'linux',
    primaryHref: DL('scry-linux-x64.AppImage'),
    downloads: [
      { label: 'AppImage',              size: '~90 MB', href: DL('scry-linux-x64.AppImage') },
      { label: 'Debian / Ubuntu (.deb)',size: '~65 MB', href: DL('scry-linux-x64.deb') },
    ],
